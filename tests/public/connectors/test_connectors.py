...
from openwatch_connectors import ConnectorRegistry, get_connector
...
class TestPortalTransparencia:
    ...
    def test_safe_float_none(self):
        from openwatch_connectors.portal_transparencia import _safe_float
    ...
    def test_parse_dimension_cursor(self):
        from openwatch_connectors.portal_transparencia import _parse_dimension_cursor
...
class TestTSECorruptZipRegression:
    ...
    async def test_corrupt_zip_raises_file_not_found_and_deletes_file(self, tmp_path):
        ...
        import os
        from openwatch_connectors.tse import _TSEJobCfg, _download_tse_dataset
