import pytest
from openwatch_er.confidence import compute_pair_confidence, compute_cluster_confidence, EvidenceType
...
def test_name_fuzzy_returns_score_below_merge_threshold():
    ...
    from openwatch_er.confidence import MERGE_THRESHOLD
