...
from openwatch_ai.provider import NoOpProvider, get_llm_provider
...
class TestGetLlmProvider:
    ...
    def test_openai_provider(self):
        from openwatch_ai.provider import OpenAIProvider
    ...
    def test_anthropic_provider(self):
        with patch("shared.ai.provider.settings") as mock_settings, \
            ...
            from openwatch_ai.provider import AnthropicProvider
            provider = get_llm_provider()
