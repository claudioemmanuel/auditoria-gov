...
from shared.connectors.domain_guard import DOMAIN_EXCEPTIONS, DomainException


class TestComplianceTask:
    def test_all_sources_pass(self):
        """All current connectors should pass domain validation."""
        from shared.connectors.domain_guard import validate_domain, DomainNotAllowedError
        from worker.tasks.compliance_tasks import _CONNECTOR_URLS
