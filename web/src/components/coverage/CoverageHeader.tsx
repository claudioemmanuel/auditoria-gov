  ...
  return (
    <div className="mt-4 flex items-center justify-between gap-3">
      <div className="flex items-center gap-3">
        <div className="rounded-xl border border-gov-gray-200 bg-gov-blue-50 p-2">
          <Database className="h-6 w-6 text-gov-blue-700" />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-gov-gray-900">Cobertura de Dados</h1>
      ...
      <div className="rounded-lg border border-gov-gray-200 bg-white px-3 py-2 text-right">
        ...
        <p className="mt-1 font-mono tabular-nums text-sm font-medium text-gov-gray-900">
