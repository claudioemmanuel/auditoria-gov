      ...
      <div className="flex items-start gap-2 py-1.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-0.5 flex flex-wrap items-center gap-2">
            <span className="rounded bg-surface-subtle px-1 py-0.5 text-xs text-secondary">
              {config.label}
            </span>
            {r.url && (
              <a
    ...
    <div className="mt-6">
              ...
              {sorted.map((item) => (
                <tr key={item.event_id} className="hover:bg-surface-subtle/50 transition-colors">
                  ...
                  <td className="px-3 py-2.5">
                    <span className="rounded bg-surface-subtle px-1.5 py-0.5 font-mono text-xs text-secondary">
      ...
      {hasPagination && (
        <div className="mt-3 flex items-center justify-between text-xs text-secondary">
          ...
          <span>
            Pagina {currentPage} de {totalPages} &mdash; {total} registros
          </span>
          <button
            type="button"
