...
import openwatch_utils.middleware.task_metrics  # noqa: F401 — registers Celery signals
...
def _reset_sync_engine_after_fork(**kwargs):
    ...
    try:
        ...
        pass
    try:
        from openwatch_db.db import engine as async_engine
...
def _cold_start_bootstrap(sender, **kwargs):
    ...
    def _on_worker_ready(sender, **kw):
        ...
        try:
            ...
            from openwatch_models.orm import IngestState, RawRun, ReferenceData
