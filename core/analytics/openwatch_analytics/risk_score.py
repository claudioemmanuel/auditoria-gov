...
from openwatch_models.orm import Entity, EventParticipant, GraphEdge, GraphNode, RiskSignal
from openwatch_queries.queries import resolve_entity_ids_with_clusters
...
async def compute_entity_risk_score(
    ...
    from openwatch_models.orm import Event  # local import to avoid circular at module level
