...
from openwatch_models.graph import CaseGraphResponse, EntityPathResponse, NeighborhoodResponse, SignalGraphResponse
from openwatch_models.orm import Case, CaseItem, Contestation, RiskSignal, Typology
...
from openwatch_db.provenance import (
...
async def list_tipologias():
    ...
    from openwatch_typologies.registry import TypologyRegistry
    from openwatch_typologies.factor_metadata import TYPOLOGY_LEGAL_METADATA
